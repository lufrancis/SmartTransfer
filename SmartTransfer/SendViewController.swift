...
class SendViewController: UIViewController, UIPickerViewDataSource, UIPickerViewDelegate, UITextFieldDelegate {
    ...
    @IBAction func buttonClicked(sender: AnyObject) {
        ...
        ActionSheetStringPicker.showPickerWithTitle("Currencies", rows: pickerDataSource, initialSelection: 1, doneBlock: { (picker, value, index) -> Void in
            println(self.pickerDataSource[value])
